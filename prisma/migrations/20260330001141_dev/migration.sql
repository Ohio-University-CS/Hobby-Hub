...
CREATE TABLE "PostInterest" (
    ...
    CONSTRAINT "PostInterest_pkey" PRIMARY KEY ("postId","interestId")
);
...
-- AddForeignKey
ALTER TABLE "PostInterest" ADD CONSTRAINT "PostInterest_postId_fkey" FOREIGN KEY ("postId") REFERENCES "posts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
